$(document).ready(function () {
    ...
    $(".3_4").click(function () {
        ...
        $("#key").html("Add ones to three-digit numbers</br>Add tens to three-digit numbers</br>Add hundreds to three-digit numbers</br>Subtract ones from three-digit numbers</br>Subtract tens from three-digit numbers</br>Subtract hundreds from three-digit numbers</br>Use column addition for numbers with up to three digits when carrying is not required</br>Use column addition for three-digit and two-digit numbers when carrying is required</br>Use column addition for numbers with three-digits when carrying is required in the ones and/or tens column</br>Use column addition for numbers with three-digits when carrying is required in the hundreds column</br>Use column subtraction for numbers with up to three digits when exchanging is not required</br>Use column subtraction for three-digit and two-digit numbers when exchanging is required</br>Use column subtraction for numbers with up to three-digits when exchanging is required</br>Estimate the answer to a calculation</br>Identify when addition or subtraction is needed as part of solving a problem");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
    ...
    $(".4_1").click(function () {
        ...
        $("#key").html("Understand place value in numbers up to 10,000</br>Order numbers up to and including those with four digits</br>Read and Write numbers up to 10, 000 using numerals</br>Read and Write numbers up to 10, 000 using words</br>Write numbers up to and including those with four digits</br>Read numbers up to and including those with four digits</br>Read Roman numerals up to C</br>Understand the difference between the Roman numeral system and the decimal number system</br>Interpret numbers up to 10 000 on a number line</br>Represent numbers up to 10 000 using a number line</br>Use and interpret scales representing measurements with numbers up to 10 000</br>Recognise that hundredths arise from dividing a number or object into one hundred equal parts</br>Read a number with two decimal places</br>Write decimal equivalents of any number of tenths</br>Write decimal equivalents of any number of hundredths");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
