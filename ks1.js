$(document).ready(function () {
    ...
    $(".2_6").click(function () {
        ...
        $("#key").html("Understand the connection between multiplication and repeated addition</br>Create mathematical statements for multiplication (groups)</br> Create mathematical statements for multiplication (multiplied by)</br>Understand that multiplication is commutative</br>Recall and use division facts for the 2 times table Part 1</br>Recall and use division facts for the 2 times table Part 2</br>Recall and use division facts for the 5 times table Part 1</br>Recall and use division facts for the 5 times table Part 2</br>Recall and use multiplication facts for the 10 times table, linking multiplying by 10 to place value Part 1</br>Recall and use multiplication facts for the 10 times table, linking multiplying by 10 to place value Part 2</br>Create mathematical statements for division (grouping)</br>Create mathematical statements for division (sharing equally)</br>Understand that division is not commutative</br>Recall and use division facts for the 2 times table Part 1</br>Recall and use division facts for the 2 times table Part 2</br>Recall and use division facts for the 5 times table Part 1</br>Recall and use division facts for the 5 times table Part 2</br>Recall and use division facts for the 10 times table Part 1</br>Recall and use division facts for the 10 times table Part 2</br>Recognise odd and even numbers");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
