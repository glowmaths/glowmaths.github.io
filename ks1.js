$(document).ready(function () {
    ...
    $(".3_7").click(function () {
        ...
        $("#key").html("Recognise a unit fraction of a set of objects</br>Recognise a non-unit fraction of a set of objects</br>Understand a unit fraction as a number</br>Understand a non-unit fraction as a number</br>Understand the concept of equivalent fractions</br>Recognise equivalent fractions (denominators multiples of each other)</br>Recognise equivalent fractions (denominators not multiples of each other)</br>Create diagrams to show equivalent fractions</br>Compare a set of unit fractions</br>Compare two fractions which have the same denominator</br>Order a set of fractions which have the same denominator</br>Compare two fractions which have the same numerator</br>Order a set of fractions which have the same numerator</br>Compare two fractions which have different numerators and denominators</br>Order a set of fractions which have different numerators and denominators");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
