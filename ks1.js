$(document).ready(function () {
    ...
    $(".1_1").click(function () {
        ...
        $(".external").children("h3").text($contents+"  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACSsfcwEY87MJDLQL10HnOda/Stage%201/St1_U1_Number_System_WR.pdf?dl=0");
    });
    $(".1_2").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AADFWTNF4Sg4ulfpRYSZ4UnJa/Stage%201/St1_U2_Visualising_Constructing_WR.pdf?dl=0");
    });
    $(".1_3").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACdFkE4s6Ufi8HRFoBpXBzba/Stage%201/St1_U3_Addition_Subtraction_1_WR.pdf?dl=0");
    });
    $(".1_4").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AADI5I-2Z4F-OK-f3VJqzhXWa/Stage%201/St1_U4_Time_WR.pdf?dl=0");
    });
    $(".1_5").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAADJZMTpCbYQJxsHyNm_96ba/Stage%201/St1_U5_Addition_Subtraction_2_WR.pdf?dl=0");
    });
    $(".1_6").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AADYoWDpFtij87wS0O1-NdX4a/Stage%201/St1_U6_Measuring_Space_WR.pdf?dl=0");
    });
    $(".1_7").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAB4LimqfSBvrGnS_lV3Xztya/Stage%201/St1_U7_Fractions_WR.pdf?dl=0");
    });
    $(".1_8").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAC8sBDMBG6TwzdI3az-tczVa/Stage%201/St1_U8_Mathematical_Movement_WR.pdf?dl=0");
    });
    $(".1_9").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAB2JkSy1U2Dml8dHfQoeQN_a/Stage%201/St1_U9_Money_WR.pdf?dl=0");
    });
    $(".1_10").click(function () {
    ...
    $(".2_1").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABy1IRZ9OyXj0fPiOX5L4-la/Stage%202/St2_U1_Number_System_WR.pdf?dl=0");
    });
    $(".2_2").click(function () {
    ...
    $(".2_4").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAByVnRKmiX7cQfaOXnt-3BIa/Stage%202/St2_U4_Addition_Subtraction_WR.pdf?dl=0");
    });
    $(".2_5").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAAHGhL-sWr_yQxJmSTXwJzXa/Stage%202/St2_U5_Money_WR.pdf?dl=0");
    });
    $(".2_6").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABc9sTB-lHvC3VeoVzY-Kvza/Stage%202/St2_U6_Multiplication_Division_WR.pdf?dl=0");
    });
    $(".2_7").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABy9C9xbgppu-WrGTYYu0VEa/Stage%202/St2_U7_Fractions_WR.pdf?dl=0");
    });
    $(".2_8").click(function () {
        $("#themes").html("Investigate mathematical language to describe movement");
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACE4GIMcyoDDWnc2wELspIua/Stage%202/St2_U8_Mathematical_Movement_WR.pdf?dl=0");
    });
    $(".2_9").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAD9sO4QZ68zrCYzEk7iPyOMa/Stage%202/St2_U9_Measuring_Space_WR.pdf?dl=0");
    });
    $(".2_10").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAB3_KdhpVM0lI3JsL7mnzcPa/Stage%202/St2_U10_Money_WR.pdf?dl=0");
    });
    $(".2_11").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABaUdLqdpc1hzSDdzb-M8lha/Stage%202/St2_U11_Presenting_Data_WR.pdf?dl=0");
    });
    $(".3_1").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AADd3Nn94UKa-69yqTR9d-c2a/Stage%203/St3_U1_Number_System_WR.pdf?dl=0");
    });
    $(".3_2").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AADR69dxD1m7I-6x4TIrHjDTa/Stage%203/St3_U2_Counting_WR.pdf?dl=0");
    });
    $(".3_3").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAA9Lgtpj_T_rHzP4v7XOwYTa/Stage%203/St3_U3_Visualising_Constructing_WR.pdf?dl=0");
    });
    $(".3_4").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACiN9hXBMWKVywuGv4dIK4sa/Stage%203/St3_U4_Addition_Subtraction_WR.pdf?dl=0");
    });
    $(".3_5").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AADZKC473ryXYZi-Avlef1jza/Stage%203/St3_U5_Multiplication_Division_WR.pdf?dl=0");
    });
    $(".3_6").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABa69fH_2qSEjF4mGmu0kcSa/Stage%203/St3_U6_Time_WR.pdf?dl=0");
    });
    $(".3_7").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABq-Cr_VdNeXkNtJgjgFHcha/Stage%203/St3_U7_Fractions_WR.pdf?dl=0");
    });
    $(".3_8").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABFCJYkLmABjdM7_oLMQzLDa/Stage%203/St3_U8_Measuring_Space_WR.pdf?dl=0");
    });
    $(".3_9").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABoNUmrhzAUtmg6ttuS60Rva/Stage%203/St3_U9_Angles_WR.pdf?dl=0");
    });
    $(".3_10").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAAeV0YReJaJYV6EOKPhECa9a/Stage%203/St3_U10_Calculating_Fractions_Decimals_WR.pdf?dl=0");
    });
    $(".3_11").click(function () {
        $("#themes").html("Explore money</br>Solve problems involving money");
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAAisxLdMzqHcU7RI5JlpgdHa/Stage%203/St3_U11_Money_WR.pdf?dl=0");
    });
    $(".3_12").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAClW3hLh5g5YUKOHoNx_qYWa/Stage%203/St3_U12_Presenting_Data_WR.pdf?dl=0");
    });
    $(".4_1").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABhPQbFkUiy-yk7CLzK8ZPxa/Stage%204/St4_U1_Number_System_WR.pdf?dl=0");
    });
    $(".4_2").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAALX4NvCzp4fW8AAa8gGev6a/Stage%204/St4_U2_Counting_WR.pdf?dl=0");
    });
    $(".4_3").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAD3NeP62S1H5jxvGAd7yzf9a/Stage%204/St4_U3_Properties_of_Shapes_WR.pdf?dl=0");
    });
    $(".4_4").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAAzki4cXdLkdJfwTta6NqlGa/Stage%204/St4_U4_Addition_Subtraction_WR.pdf?dl=0");
    });
    $(".4_5").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACVd9yMVqEEEv2TKQ41wSZda/Stage%204/St4_U5_Multiplication_Division_WR.pdf?dl=0");
    });
    $(".4_6").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAB0TPTvuZJVI7NeTLyC8mePa/Stage%204/St4_U6_Time_Money_WR.pdf?dl=0");
    });
    $(".4_7").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAAhFE0roLc7cjexeprLYjpia/Stage%204/St4_U7_Exploring_FDP_WR.pdf?dl=0");
    });
    $(".4_8").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAC7Vnjn8PJLm9-uPFn50ubJa/Stage%204/St4_U8_Measuring_Space_WR.pdf?dl=0");
    });
    $(".4_9").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACX9xhxD_W9Y2qk6XmXOzyHa/Stage%204/St4_U9_Angles_WR.pdf?dl=0");
    });
    $(".4_10").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACEuy7ef3O-1t-wJEDhET8xa/Stage%204/St4_U10_Calculating_FDP_WR.pdf?dl=0");
    });
    $(".4_11").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACxL_CUUEDPv1XkyBnonFqta/Stage%204/St4_U11_Calculating_Space_WR.pdf?dl=0");
    });
    $(".4_12").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAA_1kDCVCQ2_45v-3m6dbZSa/Stage%204/St4_U12_Checking_WR.pdf?dl=0");
    });
    $(".4_13").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACUdYtJpL_jZxHxqi4VokBka/Stage%204/St4_U13_Movement_WR.pdf?dl=0");
    });
    $(".4_14").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACZQ3NFugyqMJ7rcZUtL_yDa/Stage%204/St4_U14_Presenting_Data_WR.pdf?dl=0");
    });
    $(".5_1").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABTwVxeiTYVWZHehBrzTCpJa/Stage%205/St5_U1_Number_System_WR.pdf?dl=0");
    });
    $(".5_2").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABdSV52c7UrERkko7k4734Ha/Stage%205/St5_U2_Counting_WR.pdf?dl=0");
    });
    $(".5_3").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AADP4DrPHjp18wxmPpLLgZKDa/Stage%205/St5_U3_Addition_Subtraction_WR.pdf?dl=0");
    });
    $(".5_4").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AADCEOF3l_RuRG4dnxkd9Ue5a/Stage%205/St5_U4_Visualising_Constructing_WR.pdf?dl=0");
    });
    $(".5_5").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAB7EvIJ7SDgY7E0KWH07ETAa/Stage%205/St5_U5_Multiplication_Division_WR.pdf?dl=0");
    });
    $(".5_6").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAAPFwh411vttW19uVMjjKVDa/Stage%205/St5_U6_Properties_of_Shapes_WR.pdf?dl=0");
    });
    $(".5_7").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACtO_d3loYK-XtcTd1x4Yyka/Stage%205/St5_U7_Pattern_Sniffing_WR.pdf?dl=0");
    });
    $(".5_8").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AADLNGRnlS0-2rqoNvNWPuica/Stage%205/St5_U8_Time_WR.pdf?dl=0");
    });
    $(".5_9").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABJ-0f2inrkVJ4wNT0zRi6-a/Stage%205/St5_U9_Exploring_FDP_WR.pdf?dl=0");
    });
    $(".5_10").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACfzTJz1z7fUAFUgkoXvgmqa/Stage%205/St5_U10_Measuring_Space_WR.pdf?dl=0");
    });
    $(".5_11").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AADeuQJYPuorXOBOOiK2Mnbfa/Stage%205/St5_U11_Angles_WR.pdf?dl=0");
    });
    $(".5_12").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABCXrds2g73FUF1JkM3izw9a/Stage%205/St5_U12_Calculating_FDP_WR.pdf?dl=0");
    });
    $(".5_13").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAAmfugDz6T8w2tlri6eyUBsa/Stage%205/St5_U13_Calculating_Space_WR.pdf?dl=0");
    });
    $(".5_14").click(function () {
        $("#themes").html("Explore ways of approximating numbers</br>Explore ways of checking answers");
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAD5TWqr20gutt0n9vqb51Mka/Stage%205/St5_U14_Checking_WR.pdf?dl=0");
    });
    $(".5_15").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAD0-TJocXT4wNlU5X5daWI0a/Stage%205/St5_U15_Movement_WR.pdf?dl=0");
    });
    $(".5_16").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACziQPVlEMLexR1XjcjoICKa/Stage%205/St5_U16_Presenting_Data_WR.pdf?dl=0");
    });
    $(".6_1").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACgwxkofYMWNck2QHB4WiE9a/Stage%206/St6_U1_Number_System_WR.pdf?dl=0");
    });
    $(".6_2").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAABPFdV_LqNuChubs9d1t0ha/Stage%206/St6_U2_Calculating_WR.pdf?dl=0");
    });
    $(".6_3").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABjW69T9fL9VYdgsxc9iBkaa/Stage%206/St6_U3_Visualising_Constructing_WR.pdf?dl=0");
    });
    $(".6_4").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABEivdgxhPLQ5wpPyMA7JHBa/Stage%206/St6_U4_Division_WR.pdf?dl=0");
    });
    $(".6_5").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAA2B-XCcsMeJbPs8q8OcgcAa/Stage%206/St6_U5_Properties_of_Shapes_WR.pdf?dl=0");
    });
    $(".6_6").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAAfZuYG51ceK-DT4nQf_yNYa/Stage%206/St6_U6_Exploring_FDP_WR.pdf?dl=0");
    });
    $(".6_7").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABcaE5z_fLQgP2wA6muJL_2a/Stage%206/St6_U7_Formulae_WR.pdf?dl=0");
    });
    $(".6_8").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AADhYHefcpgFE3rGJESCTlHTa/Stage%206/St6_U8_Proportion_WR.pdf?dl=0");
    });
    $(".6_9").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AAD8nPEaiHiEI-qj0OFnR1pva/Stage%206/St6_U9_Pattern_Sniffing_WR.pdf?dl=0");
    });
    $(".6_10").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABNddzHDeRXQVTatU0qVDAea/Stage%206/St6_U10_Measuring_Space_WR.pdf?dl=0");
    });
    $(".6_11").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACPvUOlVZuEkp4dhaNkW-dta/Stage%206/St6_U11_Angles_WR.pdf?dl=0");
    });
    $(".6_12").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABHM1DkuxaLUXeAAErRfurVa/Stage%206/St6_U12_Calculating_FDP_WR.pdf?dl=0");
    });
    $(".6_13").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABeJwmpazRKneIEuzCvi7x_a/Stage%206/St6_U13_Equations_WR.pdf?dl=0");
    });
    $(".6_14").click(function () {
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AADGGJnCj5rRuxcRZ195ynhba/Stage%206/St6_U14_Calculating_Space_WR.pdf?dl=0");
    });
    $(".6_15").click(function () {
        $("#themes").html("Explore ways of approximating numbers</br>Explore ways of checking answers");
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AABTVUdQASxvO0sXeYr8uqjCa/Stage%206/St6_U15_Checking_WR.pdf?dl=0");
    });
    $(".6_16").click(function () {
        $("#themes").html("Understand and use Cartesian coordinates </br>Use transformations to move shapes");
        ...
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Download Unit Assessment (.pdf)");
        $(".download").children("a").attr("href", "https://www.dropbox.com/sh/taeg5o4vlpwggui/AACSxeh5cKYJvnHcrSVoEVmga/Stage%206/St6_U16_Movement_WR.pdf?dl=0");
    });
    $(".6_17").click(function () {
