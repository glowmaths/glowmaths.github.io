$(document).ready(function () {
    ...
    $(".2_1").click(function () {
        $("#statements").html('recognise the place value of each digit in a two-digit number (tens, ones)<br>identify, represent and estimate numbers using different representations, including<br>the number line<br>compare and order numbers from 0 up to 100; use <, > and = signs<br>read and write numbers to at least 100 in numerals and in words<br>use place value and number facts to solve problems.<br>');
    ...
    $(".2_2").click(function () {
        $("#statements").html('identify and describe the properties of 2-D shapes, including the number of sides and<br>line symmetry in a vertical line<br>identify and describe the properties of 3-D shapes, including the number of edges,<br>vertices and faces<br>identify 2-D shapes on the surface of 3-D shapes [for example, a circle on a cylinder<br>and a triangle on a pyramid]<br>compare and sort common 2-D and 3-D shapes and everyday objects.<br>');
        $("#key").html('Identify and describe the properties of pentagons<br>Identify and describe the properties of hexagons<br>Identify and describe the properties of octagons<br>Identify symmetry properties of 2-D shapes using vertical lines<br>Identify and describe the properties of 3-D shapes including the number of vertices<br>Identify and describe the properties of 3-D shapes including the number of edges<br>Identify and describe the properties of 3-D shapes including the number of faces<br>Identify and describe the properties of cylinders<br>Identify and describe the properties of cones<br>Identify and describe 2-D shapes on the surface of 3-D shapes<br>Compare and sort 2-D shapes and explain how they are similar or different<br>Compare and sort 3-D shapes and explain how they are similar or different<br>');
        var $contents = $(this).text();
        $(".external").children("h3").text($contents+"  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
        $(".download").attr("href", "#");
    });
    ...
    $(".3_8").click(function () {
        ...
        $("#key").html('Recall and use multiplication facts for the 3 times table <br>Recall and use division facts for the 3 times table<br>Build the 4x table and count in steps of 4 from zero<br>Recall and use multiplication facts for the 4 times table<br>Recall and use division facts for the 4 times table<br>Build the 8x table and count in steps of 8 from zero<br>Recall and use multiplication facts for the 8 times table<br>Recall and use division facts for the 8 times table<br>Multiply 2 digit numbers by 10 using place value<br>Multiply 1 digit numbers by multiples of 10 using place value<br>');
        var $contents = $(this).text();
        $(".external").children("h3").text($contents+"  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
        $(".download").attr("href", "#");
    });
    ...
    $(".4_3").click(function () {
        $("#statements").html('<br>');
        $("#key").html('Identify lines of symmetry of a 2D shape<br>Identify a line of symmetry of a pattern and for a diagram of a reflection<br>Use a line of symmetry to produce a symmetrical pattern<br>Use a line of symmetry to complete a symmetrical shape<br>');
        var $contents = $(this).text();
        $(".external").children("h3").text($contents+"  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
        $(".download").attr("href", "#");
    });
    ...
    $(".4_5").click(function () {
        ...
        $("#key").html('Build the 6x table and count in steps of 6 from zero<br>Recall and use multiplication facts for the 6 times table<br>Recall and use division facts for the 6 times table<br>Build the 9x table and count in steps of 9 from zero<br>Recall and use multiplication facts for the 9 times table<br>Recall and use division facts for the 9 times table<br>Build the 7x table and count in steps of 7 from zero<br>Recall and use multiplication facts for the 7 times table<br>Recall and use division facts for the 7 times table<br>Build the 11x table and count in steps of 11 from zero<br>Recall and use multiplication facts for the 11 times table<br>Recall and use division facts for the 11 times table<br>Build the 12x table and count in steps of 12 from zero<br>Recall and use multiplication facts for the 12 times table<br>Recall and use division facts for the 12 times table<br>Use knowledge of factor pairs (commutativity) when multiplying mentally three numbers together, such as 2 x 6 x 5 = 10 x 6 = 60<br>Know and use the effect of multiplying by 0 <br>Know and use the effect of multiplying by 1 <br>Know and use the effect of dividing by 1<br>');
        var $contents = $(this).text();
        $(".external").children("h3").text($contents+"  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
        $(".download").attr("href", "#");
    });
    ...
    $(".5_1").click(function () {
        ...
        $("#key").html('Represent numbers up to one million<br>Recognise the value of digits in numbers up to one million<br>Partition 6 digit numbers in different ways<br>Read 6-digit numbers in words and write using numerals<br>Read 6-digit numbers in numerals and write in words<br>Read 6-digit numbers in words and write using numerals including zero as a place holder<br>Read 6-digit numbers in numerals and write in words, including zero as a place holder<br>Identify 6-digit numbers on a number line<br>Represent 6-digit numbers on a number line<br>Compare numbers up to one million<br>Order numbers up to one million<br>Count forwards in tens and hundreds from any positive number up to 1 000 000<br>Count forwards in thousands from any positive number up to 1 000 000<br>Count backwards in tens and hundreds from any positive number up to 1 000 000<br>Count backwards in thousands from any positive number up to 1 000 000<br>Count forwards and backwards in whole number steps when negative numbers are included<br>Count forwards and backwards in whole number steps including through zero<br>Understand and use negative numbers in context, including temperatures below 0°C<br>Read Roman numerals to 1000 (M)<br>Recognise years written in Roman numerals<br>Round any 5-digit numberto the nearest 10 000<br>Round any 5-digit numberto the nearest 100 000<br>');
        var $contents = $(this).text();
        $(".external").children("h3").text($contents+"  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
        $(".download").attr("href", "#");
    });
    ...
    $(".5_3").click(function () {
        $("#statements").html('<br>');
        $("#key").html('Identify cubes from nets<br>Identify cuboids from nets<br> Identify prisms from nets<br>Identify pyramids from nets<br>Identify 3D-shapes from diagrams on isometric paper<br>');
        var $contents = $(this).text();
        $(".external").children("h3").text($contents+"  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
        $(".download").attr("href", "#");
    });
    ...
    $(".5_6").click(function () {
        ...
        $("#key").html('Find and identify multiples of a given number<br>Find and identify factors of a given number<br>Find the ‘common factor’ of two numbers<br>Know the meaning of ‘prime number’ and recall the prime numbers less than 20<br>Know the prime factors of a given number<br>Know how to test if a number up to 100 is prime<br>Know and identify square numbers<br>Know and identify cube numbers<br>');
        var $contents = $(this).text();
        $(".external").children("h3").text($contents+"  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
        $(".download").attr("href", "#");
    });
