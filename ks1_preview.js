$(document).ready(function () {
    ...
    $(".2_1").click(function () {
        ...
        $("#key").html("Explain the value of each digit in a two- digit number</br>Order two-digit numbers</br>Read and write numbers to 100 in numerals</br>Read and write numbers to 100 in words</br>Read and write numbers to 500 in numerals</br>Read and write numbers to 500 in words</br>Represent and estimate numbers using a number line</br>Compare the value of numbers explaining if they are more or less than another number or numbers</br>Compare the value of numbers explaining if they are more than, less than or equal to another number or numbers</br>Represent numbers different ways using partitioning");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
    ...
    $(".3_1").click(function () {
        ...
        $("#key").html("Understand place value in numbers up to 1000</br>Order numbers up to and including 1000</br>Read and Write numbers up to 1000 using numerals</br>Read and Write numbers up to 1000 using words</br>Read and write numbers using zero as a place holder in numbers up to 1000</br>Interpret numbers up to 1000 on a number line</br>Represent numbers up to 1000 using a number line</br>Interpret and use scales representing measurements with numbers up to 1000</br>Use scales to represent measurements with numbers up to 1000");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
    ...
    $(".3_4").click(function () {
        ...
        $("#key").html("Add ones to three-digit numbers</br>Add tens to three-digit numbers</br>Add hundreds to three-digit numbers</br>Subtract ones from three-digit numbers</br>Subtract tens from three-digit numbers</br>Subtract hundreds from three-digit numbers</br>Use column addition for three-digit and two-digit numbers when regrouping (carrying)  is not required</br>Use column addition for three-digit and two-digit numbers when regrouping (carrying)  is required in the ones column</br>Use column addition for three-digit and two-digit numbers when regrouping (carrying)  is required in the tens column</br>Use column addition for two three-digit numbers when regrouping (carrying)  is not required</br>Use column addition for numbers with three-digits when regrouping (carrying)  is required in the ones column</br>Use column addition for numbers with three-digits when regrouping (carrying)  is required in the tens column</br>Use column addition for numbers with three-digits when regrouping (carrying)  is required in the hundreds column</br>Use column subtraction for three and two-digit numbers when exchanging is not required</br>Use column subtraction for three-digit and two-digit numbers when exchanging is required in the tens column</br>Use column subtraction for three-digit and two-digit numbers when exchanging is required in the hundreds column</br>Use column subtraction for numbers with three-digits when exchanging is required</br>Use column subtraction for three-digit numbers when exchanging is required in the tens column</br>Use column subtraction for three-digit numbers when exchanging is required in the hundreds column</br>Estimate the answer to a calculation");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
    ...
    $(".3_5").click(function () {
        ...
        $("#key").html("Recall and use multiplication facts for the 3 times table </br>Recall and use multiplication facts for the 4 times table</br>Recall and use multiplication facts for the 8 times table</br>Recall and use division facts for the 3 times table</br>Recall and use division facts for the 4 times table</br>Recall and use division facts for the 8 times table</br>Multiply 2 digit numbers by 10 using place value</br>Multiply 2 digit numbers by multiples of 10 using place value</br>Understand the distributive law applied to a multiplication of a two-digit number by a one-digit number</br>Identify the correct operation(s) required in order to solve a problem and create mathematical statements </br>Use known and derived facts when multiplying mentally</br>Use known and derived facts when dividing mentally</br>Use efficient methods to multiply a two-digit number by a one-digit number</br>Identify when a scaling (or correspondence problem) can be solved using multiplication or division");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
    ...
    $(".3_7").click(function () {
        ...
        $("#key").html("Find unit fractions of a number of objects (5,8,10)</br>Find unit fractions of an amount</br>Find non-unit fractions of a number of objects (2,3,5,8,10)</br>Find non-unit fractions of an amount</br>Add fractions same denominator within the whole</br>Subtract fractions same denominator within the whole</br>Recognise equivalent fractions (denominators multiples of each other)</br>Recognise equivalent fractions (denominators not multiples of each other)</br>Compare a set of unit fractions</br>Compare two fractions which have the same denominator</br>Order a set of fractions which have the same denominator</br>Compare two fractions which have the same numerator</br>Order a set of fractions which have the same numerator</br>Compare two fractions which have different numerators and denominators</br>Order a set of fractions which have different numerators and denominators");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
    ...
    $(".4_1").click(function () {
        $("#statements").html("recognise the place value of each digit in a four-digit number (thousands, hundreds, tens, and ones)</br>read Roman numerals to 100 (I to C) and know that over time, the numeral system changed to include the concept of zero and place value</br>identify, represent and estimate numbers using different representations</br>count up and down in hundredths; recognise that hundredths arise when dividing an object by one hundred and dividing tenths by ten</br>recognise and write decimal equivalents of any number of tenths or hundredths");
        $("#themes").html("Develop knowledge of place value</br>Explore numbers less than 10 000</br>Explore decimals</br>Understand and use Roman numerals</br>Explore the history of our number system</br>Explore ways of representing numbers");
        $("#key").html("Understand place value in numbers up to 10,000</br>Order numbers up to and including those with four digits</br>Read and Write numbers up to 10, 000 using numerals</br>Read and Write numbers up to 10, 000 using words</br>Read Roman numerals up to C</br>Understand the difference between the Roman numeral system and the decimal number system</br>Interpret numbers up to 10 000 on a number line</br>Represent numbers up to 10 000 using a number line</br>Use and interpret scales representing measurements with numbers up to 10 000</br>Recognise that hundredths arise from dividing a number or object into one hundred equal parts</br>Read a number with two decimal places</br>Write decimal equivalents of any number of tenths</br>Write decimal equivalents of any number of hundredths");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
    ...
    $(".4_2").click(function () {
        $("#statements").html("order and compare numbers beyond 1000</br>count in multiples of 6, 7, 9, 25 and 1000</br>count backwards through zero to include negative numbers</br>count up and down in hundredths</br>compare numbers with the same number of decimal places up to two decimal places");
    ...
    $(".4_4").click(function () {
        ...
        $("#key").html("Find 1000 more than a given number</br>Find 1000 less than a given number</br>Use columnar addition for four-digit and three-digit numbers with no regrouping (carrying) required</br>Use columnar addition for four-digit and three-digit numbers with regrouping (carrying) required in the ones column</br>Use columnar addition for four-digit and three-digit numbers with regrouping (carrying) required in the tens column</br>Use columnar addition for four-digit and three-digit numbers with regrouping (carrying)  required in the hundreds column</br>Use columnar addition for four-digit numbers with no regrouping (carrying) required</br>Use columnar addition for four-digit numbers with regrouping (carrying) required in the ones column</br>Use columnar addition for four-digit numbers with regrouping (carrying)  required in the tens column</br>Use columnar addition for four-digit numbers with regrouping (carrying)  required in the hundreds column</br>Use columnar addition for four-digit numbers with regrouping (carrying) required in the thousands column</br>Use columnar subtraction for four-digit and three-digit numbers numbers with no exchanging required</br>Use columnar subtraction for four-digit and three-digit numbers with exchanging required in the tens column</br>Use columnar subtraction for four-digit and three-digit numbers with exchanging required in the hundreds column</br>Use columnar subtraction for four-digit and three-digit numbers with exchanging required in the thousands column</br>Use columnar subtraction for four-digit numbers with no exchanging required</br>Use columnar subtraction for four-digit numbers with exchanging required in the tens column</br>Use columnar subtraction for four-digit numbers with exchanging required in the hundreds column</br>Use columnar subtraction for four-digit numbers with exchanging required in the thousands column</br>Use columnar addition for numbers with 2 decimal places with regrouping (carrying)  required</br>Add numbers with a mixture of 1 and 2 decimal places</br>Use columnar subtraction for numbers with 2 decimal places with exchanging required</br>Subtract numbers with a mixture of 1 and 2 decimal places");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
    ...
    $(".5_2").click(function () {
        $("#statements").html("Develop knowledge of place value</br>read, write, order and compare numbers to at least 1 000 000 and determine the value of each digit</br>read Roman numerals to 1000 (M) and recognise years written in Roman numerals</br>interpret negative numbers in context, count forwards and backwards with positive and negative whole numbers, including through zero</br>recognise and use thousandths and relate them to tenths, hundredths and decimal equivalents</br>read, write, order and compare numbers with up to three decimal places");
        $("#themes").html("Work with numbers up to one million</br>Understand and use Roman numerals</br>Understand and use negative numbers</br>Explore decimals");
        $("#key").html("Understand place value in numbers with up to seven digits</br>Order numbers up to and including those with seven digits</br>Write and read numbers up to and including those with seven digits</br>Read Roman numerals to 1000 (M)</br>Recognise years written in Roman numerals</br>Count forwards and backwards in whole number steps when negative numbers are included</br>Count forwards and backwards in whole number steps including through zero</br>Understand and use negative numbers in context, including temperatures below 0°C</br>Recognise that thousandths arise from dividing a number (or object) into one thousand equal parts and dividing hundredths by ten</br>Read a number with three decimal places</br>Write decimal equivalents of any number of thousandths</br>Compare and order a set of numbers written to three decimal places</br>Compare and order a set of numbers with a mixed number of decimal places");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
    ...
    $(".5_3").click(function () {
        ...
        $("#key").html("Add four-digit numbers and ones, tens and hundreds mentally</br>Add four-digit numbers and thousands mentally</br>Subtract four-digit numbers and ones, tens and hundreds mentally</br>Subtract four-digit numbers and thousands mentally</br>Use columnar addition for numbers with more than four digits with no regrouping (carrying)  required</br>Use columnar addition for numbers with more than four digits with regrouping (carrying) required</br>Use columnar subtraction for numbers with more than four digits with no exchanging required</br>Use columnar subtraction for numbers with more than four digits with exchanging required</br>Use columnar addition for numbers with 3 decimal places with regrouping (carrying) required</br>Add numbers with a mixture of 2 and 3 decimal places</br>Add numbers with a mixture of 1, 2 and 3 decimal places</br>Use columnar subtraction for numbers with 3 decimal places with exchanging required</br>Subtract numbers with a mixture of 2 and 3 decimal places</br>Subtract numbers with a mixture of 1, 2 and 3 decimal places");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
    ...
    $(".5_4").click(function () {
        ...
        $("#key").html("Identify 3D shapes from 2D representations</br>Identify cubes from nets</br>Identify cuboids from nets</br>Identify prisms from nets</br>Identify pyramids from nets");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
    ...
    $(".5_9").click(function () {
        $("#statements").html("compare and order fractions whose denominators are all multiples of the same number</br>identify, name and write equivalent fractions of a given fraction, represented visually, including tenths and hundredths</br>read and write decimal numbers as fractions [for example, 0.71 = 71/100]</br>recognise the per cent symbol (%) and understand that per cent relates to ‘number of parts per hundred’, and write percentages as a fraction with denominator 100, and as a decimal");
    ...
    $(".5_12").click(function () {
        ...
        $("#key").html("Convert a mixed number into an improper fraction (and vice versa)</br>Add proper fractions (same denominator) beyond the whole (mixed number answer)</br>Add proper fractions (denominator multiples of each other) within the whole </br>Add proper fractions (denominator multiples of each other) beyond the whole (mixed number answer)</br>Add mixed and proper fraction, fractions within the whole (same denominator) (mixed number answer)</br>Add mixed and proper fraction, fractions beyond the whole (same denominator) (mixed number answer)</br>Add mixed and proper fraction, fractions within the whole (denominator multiples of each other) (mixed number answer)</br>Add mixed and proper fraction, fractions beyond the whole (denominator multiples of each other) (mixed number answer)</br>Subtract proper fraction from mixed number (same denominator) within the whole</br>Subtract proper fraction from mixed number (same denominator) across the whole</br>Subtract proper fractions (denominator multiples of each other) within the whole</br>Subtract proper fractions from mixed number (denominator multiples of each other) within the whole</br>Subtract proper fractions from mixed number (denominator multiples of each other) across the whole</br>Multiply unit fraction by a whole number</br>Multiply non-unit fraction by a whole number</br>Multiply mixed number by a whole number</br>Multiply mixed number by a whole number (beyond whole)</br>Know percentage equivalents of 1/2, 1/4, 1/5, 2/5, 4/5 and fractions with a denominator of 10 and 100</br>Establish percentage equivalents of fractions with a denominator of 20, 25, 40 and 50</br>Know decimal equivalents of 1/2, 1/4, 1/5, 2/5, 4/5 and fractions with a denominator of 10 and 100</br>Establish decimal equivalents of fractions with a denominator of 20, 25, 40 and 50");
        var $contents = $(this).text();
        $(".external").children("h3").text($contents + "  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
