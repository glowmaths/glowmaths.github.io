$(document).ready(function () {
    ...
    $(".6_1").click(function () {
        $("#statements").html('read, write, order and compare numbers up to 10 000 000 and determine the value of each digit<br>round any whole number to a required degree of accuracy<br>use negative numbers in context, and calculate intervals across zero<br>solve number and practical problems that involve all of the above <br>(From Fractions, Including Decimals and Percentages) Identify the value of each digit in numbers given to 3 decimal places and multiply <br>and divide numbers by 10, 100 and 1000 giving answers up to 3 decimal places <br>');
        $("#key").html('Represent 7-digit numbers <br>Recognise the value of digits in 7-digit numbers<br>Partition 7-digit numbers in different ways<br>Read 7-digit numbers in words and write using numerals<br>Read 7-digit numbers in numerals and write in words<br>Read 7-digit numbers in words and write using numerals including zero as a place holder<br>Read 7-digit numbers in numerals and write in words, including zero as a place holder<br>Identify 7-digit numbers  on a number line<br>Represent 7-digit numbers on a number line<br>Compare numbers up to 10,000,000 <br>Order numbers up to 10,000,000 <br>Round whole numbers to different degrees of accuracy <br>Identify the value of digits in decimal numbers <br>Multiply decimals (up to 3dp) by 10<br>Multiply decimals (up to 3dp) by 100<br>Multiply decimals (up to 3dp) by 1000<br>Divide decimals (up to 3dp) by 10 <br>Divide decimals (up to 3dp) by 100<br>Divide decimals (up to 3dp) by 1000<br>Understand and use negative numbers when working in context, such as temperature<br>Calculate intervals across zero<br>');
        var $contents = $(this).text();
        $(".external").children("h3").text($contents+"  -   Fluency, Reasoning and Solving Problems Exemplification (.pdf)");
        $(".download").attr("href", "#");
    });
